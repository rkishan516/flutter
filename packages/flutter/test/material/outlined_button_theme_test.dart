...
void main() {
  ...
  testWidgets('OutlinedButtonTheme.select only rebuilds when the selected property changes', (
    WidgetTester tester,
  ) async {
    int buildCount = 0;
    ...
    final ButtonStyle style1 = OutlinedButton.styleFrom(backgroundColor: Colors.red);
    final ButtonStyle style2 = OutlinedButton.styleFrom(backgroundColor: Colors.blue);
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: OutlinedButtonTheme(
          data: OutlinedButtonThemeData(style: style1),
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: OutlinedButtonTheme(
          data: OutlinedButtonThemeData(style: style1), // Same style object
          child: singletonThemeSubtree,
        ),
      ),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: OutlinedButtonTheme(
          data: OutlinedButtonThemeData(style: style2), // Different style object
          child: singletonThemeSubtree,
        ),
      ),
    );
