...
void main() {
  ...
  testWidgets('NavigationDrawerTheme.select only rebuilds when the selected property changes', (
    WidgetTester tester,
  ) async {
    int buildCount = 0;
    late Color? backgroundColor; // Use nullable Color?
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: NavigationDrawerTheme(
          data: const NavigationDrawerThemeData(backgroundColor: color1),
