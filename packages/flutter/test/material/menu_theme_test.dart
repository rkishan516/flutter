...
void main() {
  ...
  testWidgets('MenuTheme.select only rebuilds when the selected property changes', (
    WidgetTester tester,
  ) async {
    int buildCount = 0;
    late MenuStyle? style; // Use nullable MenuStyle?
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: MenuTheme(data: const MenuThemeData(style: style1), child: singletonThemeSubtree),
      ),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: MenuTheme(
          data: const MenuThemeData(style: style1), // Same style object
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: MenuTheme(
          data: const MenuThemeData(style: style2), // Different style object
          child: singletonThemeSubtree,
        ),
      ),
    );
