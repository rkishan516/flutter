...
void main() {
  ...
  testWidgets('DatePickerTheme.select only rebuilds when the selected property changes', (
    WidgetTester tester,
  ) async {
    int buildCount = 0;
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: DatePickerTheme(
          data: const DatePickerThemeData(backgroundColor: color1),
